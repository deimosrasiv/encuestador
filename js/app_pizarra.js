...
console.log("Su resolución es de: " + screen.height + "x" + screen.width);
var pantalla = ((screen.height * 94)/100);
console.log(pantalla);

document.getElementById("box_felicita").style.height = pantalla + "px";
document.getElementById("box_reclama").style.height = pantalla + "px";
document.getElementById("box_sugiere").style.height = pantalla + "px";
...
db.collection("bdfelicitaciones")
  .where("fecha", "==", fechaingreso)
  .orderBy("hora", "desc")
  .onSnapshot((querySnapshot) => {
