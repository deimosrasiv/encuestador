...
//console.log(fechaingreso);
  ...
  db.collection("preg_servcliente").where("estado", "==", 1).onSnapshot((querySnapshot)=> {
   var contador = 1;
...
console.log(horaingreso);
  ...
  var nombre_bd = "notas_servcliente";
...
//var divisor =
var sumanota = (nota_1+nota_2+nota_3+nota_4+nota_5+nota_6+nota_7+nota_8)
